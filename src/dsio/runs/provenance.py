...
class EnvState(DsioModel):
    ...
    cudnn: str | None = None
    gpu: str | None = None
    #: Legacy field retained so previously recorded run documents remain readable.
    #: New distributions have one required dependency contract and leave this unset.
    extra: str | None = None
