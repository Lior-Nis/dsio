"""Project-owned Prefect DAG for ROGII Wellbore Geology."""
...
from reference_projects.kaggle.rogii.tasks import (
    SPLIT_PARAMETERS,
    evaluate_model,
    export,
    infer_and_submit,
...
@flow(name="kaggle-rogii-consumer", persist_result=False)
def rogii_flow(data_dir: str, workspace: str, *, seed: int = 19) -> dict[str, Any]:
    experiment_id = resolve_experiment("dsio-kaggle-rogii").experiment_id
