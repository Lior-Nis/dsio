"""Project-owned Prefect DAG for Automated Essay Scoring 2.0."""
...
from reference_projects.kaggle.essay_scoring.tasks import (
    SPLIT_PARAMETERS,
    evaluate_model,
    export,
    infer_and_submit,
...
@flow(name="kaggle-essay-scoring-consumer", persist_result=False)
def essay_scoring_flow(data_dir: str, workspace: str, *, seed: int = 19) -> dict[str, Any]:
    experiment_id = resolve_experiment("dsio-kaggle-essay-scoring").experiment_id
